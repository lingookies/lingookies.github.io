...
Lucia Dallaspezia acts as the Data Controller responsible for the processing of your personal data.

* Name: Lucia Dallaspezia
* Located in Morfasso, Piacenza, Italy
* Email: contact@lingookies.com
...
EU Representative: Lucia Dallaspezia
...
The Application saves your score or number of tries in any given interactive exercise and displays it on selected pages to show you your progress. You can delete this data at any time on the Settings page (reachable through the bottom navigational bar).

Premium users can also save their own list of favorite collocations. You can also delete this data on the Settings page.
...
The Application collects device advertising identifiers (like the Google Advertising ID) to serve ads. Third-party vendors, including Google, use these identifiers to serve ads based on your prior usage.
...
To request deletion of your personal data, withdraw consent, or exercise any of your rights, contact the Service Provider at contact@lingookies.com.
...
You have the right to request deletion of your personal data at any time, except where retention is required by law. If you’d like the Service Provider to delete User Provided Data that you have provided via the Application, please contact them at contact@lingookies.com and they will respond within the time required by applicable law. Please note that some User Provided Data may be required in order for the Application to function properly.
...
Alternatively, you can contact the Service Provider at contact@lingookies.com. The Service Provider will process your request within the timeframes required by applicable law.
...
Please note that the Application utilizes third-party services that have their own Privacy Policy about handling and deleting data. Below are the links to the Privacy Policy of the third-party service providers used by the Application:
...
Previous versions of this Privacy Policy will be maintained and made available upon request by contacting the Service Provider at contact@lingookies.com.
...
To exercise any of these rights, please contact the Service Provider at contact@lingookies.com. The Service Provider will verify your request using the information you provide and respond within the timeframes required by law. You may designate an authorized agent to make a request on your behalf.
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at contact@lingookies.com.
